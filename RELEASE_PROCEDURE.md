...
```bash
sh -c "cat gloire-<yyyymmdd>-x86_64.iso > /dev/<desired device>"
```

Otherwise they can be booted from QEMU with a command like:
...
gpg --verify gloire-<yyyymmdd>-x86_64.iso.sig
```
